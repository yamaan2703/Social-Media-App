...
//         </View>
//         <View style={tw`my-5`}>
//           <Text style={tw`flex items-center text-lg text-white`}>
...
//       <View
//         style={tw`p-5 bg-[#3A6A75] rounded-xl shadow-2xl shadow-slate-100 w-[300px]`}>
//         <View>
//           <Text style={tw`text-white font-bold text-3xl my-2`}>SignUp</Text>
//         </View>
//         <View style={tw`flex justify-center items-center`}>
...
//           <TouchableOpacity onPress={handleSignUp}>
//             <Text
//               style={tw`bg-slate-900 text-white text-center text-xl rounded-3xl p-2 w-[150px] mx-auto mt-10`}>
//               SignUp
//             </Text>
//           </TouchableOpacity>
//         </View>
